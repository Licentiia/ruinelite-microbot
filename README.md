...
<!-- BADGE:START -->
![RuinElite Release](https://img.shields.io/badge/RuinElite-1.9.8.1_nightly-blue?style=flat)
<!-- BADGE:END -->
...
|---|---|---|
| **RuinElite** | `nightly` | ![Build](https://img.shields.io/github/actions/workflow/status/Licentiia/ruinelite-microbot/CI.yml?branch=main&label=Build&style=flat) |
